...
namespace Assets.Plugins.Editor.Rider {
    ...
    public static class RiderPlugin {
        ...
        public static bool IsDotNetFrameworkUsed {
            get { return RiderFileInfo.Extension == ".exe"; }
        }
            ...
            if(Enabled && (RiderFileInfo.Exists || RiderFileInfo.Extension == ".app")) {
                ...
                if(selected.GetType().ToString() == "UnityEditor.MonoScript" ||
                   selected.GetType().ToString() == "UnityEngine.Shader") {
                    ...
                    var args = string.Format("{0}{1}{0} -l {2} {0}{3}{0}", "\"", SlnFile, line,
                        completeFilepath);
...
//            Debug.Log("[Rider] " + message);
        ...
        static class User32Dll {
            ...
            private delegate Int32 EnumWindowsProc(IntPtr hwnd, IntPtr lParam);

            [DllImport("user32.dll", CharSet = CharSet.Unicode, PreserveSig = true, SetLastError = true,
                 ExactSpelling = true)]
            private static extern Int32 EnumWindows(IntPtr lpEnumFunc, IntPtr lParam);
